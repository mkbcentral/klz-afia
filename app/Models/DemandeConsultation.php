...
class DemandeConsultation extends Model
{
    ...
    public function getHospitalises($id){
    ...
    public function signeVito(){
        return $this->hasOne(SigneDemande::class);
    }
    ...
    public function paterns(){
        return $this->belongsToMany(MedPatern::class)->withPivot(['id','qty']);
    }
    ...
    public function accompte(){
        return $this->hasOne(Accompte::class);
    }
    ...
    /**
     * Get the user that owns the DemandeConsultation
     *
    ...
    public function getTotalPrive($id){
        ...
        if ($demande->reduction==null) {
            ...
            $total_echo+$total_autres+$total_sejour+$total_nursing+$total_medication;
        }else{
            return $total_general=+$mt_cons+$total_labo+$total_radio+$total_product+
            $total_echo+$total_autres+$total_sejour+$total_nursing+$total_medication-$demande->reduction->mt;
        }
    ...
    public function getTotalPrivePhamra($id){
        $total_general=0;
        $total_product=0;$total_medication=0;
        $demande=DemandeConsultation::find($id);
    ...
    public function getTotalAbonne($id){
        $demande=DemandeConsultation::find($id);
        $valeur_taux=0;
        if ($demande->rate==null) {
            $taux=Taux::find(1);
    ...
    public function getTotalPharma($id){
        ...
        return $total_product+$total_medication;
