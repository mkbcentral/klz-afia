...
class HistoriqueDemandeVilleComponent extends Component
{
    use WithPagination;
...
//----------- FIN -----------------
    ...
    public function render()
    {
       ...
       ->whereYear('demande_consultations.created_at',$this->currentYear)
        ->where('demande_consultations.source','Ville')
         ->get();
        ...
        return view('livewire.demandes.abonnes.historique-demande-ville-component',
            [ 'factures'=>$data]
        );
    }
}
