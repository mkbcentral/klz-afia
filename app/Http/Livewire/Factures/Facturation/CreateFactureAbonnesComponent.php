...
class CreateFactureAbonnesComponent extends Component
{
    ...
    public function mount(){
        ...
        $this->products=Product::where('is_depreciated',false)->orderBy('name','ASC')->get();
    ...
    {
        return view('livewire.factures.facturation.create-facture-abonnes-component');
    }
}
