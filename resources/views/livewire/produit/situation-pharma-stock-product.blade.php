        ...
        <div class="card card-primary card-outline">
          <div class="card-header">
              <div class="d-flex justify-content-between">
                  ...
                  <div class="mr-4">
                        <a target="_blank" href="{{ route('product.pharma.stock.fin') }}">Imprimer</a>
                  </div>
              </div>
            <!-- /.card-tools -->
          </div>
                        ...
                        <table class="table table-striped table-sm">
                            <thead class="thead-dark">
                                <tr><th>NOM PRODUIT</th>
                                    ...
                                    <th class="text-right">MT A GAGNER PRIVE</th>
                                    <th class="text-right">MT A GAGNER ABONNES</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($products as $product)
                                    ...
                                    @if ($stock_dispo>0)
                                        <tr>
                                            ...
                                            @endif
                                            <td class="text-right">
                                                {{$product->price*$stock_dispo}}
                                            </td>
                                            <td class="text-right">
                                                {{$product->price_abonne*$stock_dispo}}
                                            </td>
                                            @php
