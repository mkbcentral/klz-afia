<!-- Modal -->
<div wire:ignore.self class="modal fade" id="showDetailEncodageAbnVillle" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                            ...
                            <div>
                                @if (Auth::user()->role=='infirmerie' or Auth::user()->role=='Admin')
                                    @if ($demande->signeVito != null)
                                        ...
                                        <div><span class="text-bold">Temp °:</span> {{$demande->signeVito->temperature}}</div>
                                                ...
                                                @else
                                                   <td>
                                                    <div class="form-group">
                                                        <select id="my-select" class="form-control" wire:model.defer="cons_id_abn">
