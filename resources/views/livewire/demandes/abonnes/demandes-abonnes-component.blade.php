<div>
        ...
        <div class="card-header">
            <div class="d-flex justify-content-between">
                ...
                @if (!$factures->isEmpty())
                    ...
                    <div>
                        <div class="p-3">
                            <a target="_blank" href="{{ route('print.reception.month.abonnes',[$currentDate,$abonnement_data]) }}">Imprimer</a>
                        </div>
                    </div>
                @endif
            </div>
                                ...
                                @foreach ($factures as $facture)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <button wire:click='getInfos({{$facture->id}})' data-toggle="modal" data-target="#addSigneVitauxAbnModal" class="btn btn-primary btn-sm"><i class="fa fa-user-plus" aria-hidden="true"></i></button>
                                            @else
                                                <span>Ok !</span>
                                            @endif
                                        </td>
    ...
    @include('livewire.demandes.abonnes.detail-demandes-abonnes')
    @include('livewire.nursing.modal.add-signes-abonnes-demande')
