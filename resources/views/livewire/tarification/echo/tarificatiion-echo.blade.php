<div class="p-0">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-primary btn-sm"
                                         data-toggle="modal" data-target="#editEchoTarif"
                                         wire:click='edit({{$echo->id}})'
                                         type="button"><i class="fas fa-edit"></i></button>
                                        @if ($echo->is_changed==false)
                                            <button class="btn btn-danger btn-sm" wire:click='unActivate({{$echo->id}})' type="button"><i class="fa fa-trash" aria-hidden="true"></i></button>
                                        @else
                                            <button class="btn btn-success btn-sm" wire:click='activate({{$echo->id}}})' type="button"><i class="fa fa-check-circle" aria-hidden="true"></i></button>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
    ...
    @include('livewire.tarification.echo.edit-echo-tartif')
</div>
