            ...
            <table class="" style="margin-left: 10px;margin-top: 10px">
                <thead class="">
                    <tr>
                        ...
                        <th style="text-align: right">PRIX ABONNE USD</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right">{{ $consultation->price_abonne }}</td>
                    </tr>
                @endforeach
                </tbody>
            ...
            <table class="" style="margin-left: 10px;margin-top: 10px">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right">{{ $labo->price_abonne }}</td>
                    </tr>
                @endforeach
                </tbody>
            ...
            <table class="" style="margin-left: 10px;margin-top: 10px">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right">{{ $radio->price_abonne }}</td>
                    </tr>
                @endforeach
                </tbody>
            ...
            <table class="" style="margin-left: 10px;margin-top: 10px">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right">{{ $echo->price_abonne }}</td>
                    </tr>
                @endforeach
                </tbody>
            ...
            <table class="" style="margin-left: 10px;margin-top: 10px">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right">{{ $acte->price_abonne }}</td>
                    </tr>
                @endforeach
                </tbody>
            ...
            <table class="" style="margin-left: 10px;margin-top: 10px">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right">{{ $autre->price_abonne }}</td>
                    </tr>
                @endforeach
                </tbody>
            ...
            <table class="" style="margin-left: 10px;margin-top: 10px">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right">{{ $sejour->price_abonne }}</td>
                    </tr>
                @endforeach
                </tbody>
