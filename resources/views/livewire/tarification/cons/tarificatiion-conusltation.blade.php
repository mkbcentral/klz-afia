<div class="p-0">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-primary btn-sm"
                                         data-toggle="modal" data-target="#editConsTarif"
                                         wire:click='edit({{$consultation->id}})'
                                         type="button"><i class="fas fa-edit"></i></button>
                                        @if ($consultation->is_changed==false)
                                            <button class="btn btn-danger btn-sm" wire:click='unActivate({{$consultation->id}})' type="button"><i class="fa fa-trash" aria-hidden="true"></i></button>
                                        @else
                                            <button class="btn btn-success btn-sm" wire:click='activate({{$consultation->id}}})' type="button"><i class="fa fa-check-circle" aria-hidden="true"></i></button>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
    ...
    @include('livewire.tarification.cons.edit-cons-tartif')
</div>
