<div class="p-0">
    ...
    <div class="row">
        <div class="col-md-8">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-primary btn-sm"
                                         data-toggle="modal" data-target="#editRadioTarif"
                                         wire:click='edit({{$radio->id}})'
                                         type="button"><i class="fas fa-edit"></i></button>
                                        @if ($radio->is_changed==false)
                                            <button class="btn btn-danger btn-sm" wire:click='unActivate({{$radio->id}})' type="button"><i class="fa fa-trash" aria-hidden="true"></i></button>
                                        @else
                                            <button class="btn btn-success btn-sm" wire:click='activate({{$radio->id}}})' type="button"><i class="fa fa-check-circle" aria-hidden="true"></i></button>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
            ...
            <div>
                {{$radios->links('pagination::bootstrap-4')}}
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
    ...
    @include('livewire.tarification.radio.edit-radio-tartif')
</div>
