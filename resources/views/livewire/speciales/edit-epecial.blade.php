<div wire:ignore.self id="editDemandeSpecialModdal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input  class="form-control" type="text" wire:keydown.enter='editNumAndDate' wire:model.defer="name_patient">
                </div>
                <div class="form-group">
