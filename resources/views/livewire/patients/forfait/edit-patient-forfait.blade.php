<div wire:ignore.self id="editPatientForfait" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" wire:model.defer='societe_id'>
                        <option value="{{$societe_id}}">{{$societe_name_to_edit}}</option>
            ...
            <div class="modal-footer">
                <button wire:click='update' class="btn btn-info" type="button"><i class="fa fa-check" aria-hidden="true"></i> Ajouter</button>
            </div>
        </div>
    </div>
</div>
