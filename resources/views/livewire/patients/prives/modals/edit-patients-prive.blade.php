<div wire:ignore.self id="EditPatientPriveModal" class="modal fade" tabindex="-1" role="dialog"
    aria-labelledby="my-modal-title" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title text-bold text-danger" id="my-modal-title">
                    <span style="font-size: 20px;">EDITION D'UN NOUVEAU PATIENT PRIVE</span>
                </h3>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input wire:keydown.enter="update" class="form-control" type="text"
            ...
            <div class="modal-footer ">
                ...
                <div>
                    <button wire:click='update' class="btn btn-secondary" type="button">
                        <i class="fas fa-sync-alt"></i> Mettre à jour</button>
                </div>
            </div>
        </div>
    </div>
