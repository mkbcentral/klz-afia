<div wire:ignore.self id="DmdConsPersonnelDModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
               ...
               <div class="card">
                ...
                @if ($patient_data != null)
                    <div class="card-body">
                            ...
                            <div><strong>Service: </strong>{{$patient_data->service->name}}</div>
                    </div>
                @endif
               </div>
