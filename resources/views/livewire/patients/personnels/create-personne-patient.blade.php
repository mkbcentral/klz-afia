<div>
    <div wire:ignore.self class="modal fade" id="addAyantDroitModal">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header bg-info">
                    <h3 class="modal-title text-bold text-danger" id="my-modal-title">
                        <span style="font-size: 20px;">CREATION D'UN NOUVEAU PATIENT PERSONNEL</span>
                    </h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="date" wire:model.defer="date_venu">
                                    @error('numero')
                                        <span class="error text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="d-flex justify-content-sm-between">
                            ...
                            <div class="row">
                                <button type="submit" class="btn btn-primary"
                                    wire:click="store()">Sauvegarder</button>
                            </div>
                        </div>
                    </div>
                </div>
