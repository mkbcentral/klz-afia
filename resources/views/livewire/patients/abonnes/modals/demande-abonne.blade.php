<div wire:ignore.self id="DmdConsDModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
               ...
               <div class="card">
                ...
                @if ($patient_data != null)
                    <div class="card-body">
                            ...
                            <div><strong>Societé: </strong>{{$patient_data->abonnement->name}}</div>
                    </div>
                @endif
               </div>
