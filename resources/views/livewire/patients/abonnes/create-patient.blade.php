<div wire:ignore.self id="AddPatientAbonneModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title text-bold text-primary" id="my-modal-title">
                    <span style="font-size: 20px;">CREATION D'UN NOUVEAU PATIENT ABONNES</span>
                </h3>
            </div>
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="my-select">Nom de la societé</label>
                            <select class="form-control" wire:model.defer='abonnement_id'>
                                <option>Choisir la societé ici...</option>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            @error('matricule') <span class="text-danger error">{{ $message }}</span> @enderror
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal-footer ">
                ...
                <div>
                    <button wire:click='store' class="btn btn-danger" type="button">
