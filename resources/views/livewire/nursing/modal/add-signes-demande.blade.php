<!-- Modal -->
<div wire:ignore.self class="modal fade" id="addSigneVitauxPvModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
           ...
           <div class="card">
               <div class="card-body">
                @if ($demade_select != null)
                    <div class="p-2">
                        <div><i class="fa fa-user" aria-hidden="true"></i><span class="text-bold">Nom:</span> {{$demade_select->Nom.' '.$demade_select->Prenom}} </div>
                        <div><i class="fa fa-user" aria-hidden="true"></i><span class="text-bold">Nom:</span> {{$demade_select->fiche->patientPrive->getAge($demade_select->fiche->patientPrive->id)}} Ans</div>
                    </div>
                @endif
               </div>
           </div>
