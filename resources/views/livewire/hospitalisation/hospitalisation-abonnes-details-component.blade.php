<div>
    ...
    <div class="col-md-12">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($facture_data->products as $key => $product)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">{{$product->getQtSurvTotal($product->id)}}</td>
                                                        <td>{{$product->pivot->qty-$product->getQtSurvTotal($product->id)}}</td>
                                                        <td>
                                                            @if ($product->pivot->qty==$product->getQtSurvTotal($product->id))
                                                            <span class="text-danger">Finis !</span>
                                                            @else
                                                                <button wire:click='show({{$product->id}})'
                                                                    data-toggle="modal" data-target="#addSurProductsAbonnesModal"
                                ...
                                <div class="d-flex justify-content-between p-2">
                                    <div>
                                        <div class="form-group">
                                            <input id="my-input" class="form-control" type="date" wire:keydown.enter='getByDay' wire:model.defer="dateToSearch">
                                        </div>
                                    </div>
                                    <div>
     ...
     @include('livewire.hospitalisation.modals.add-prod-surveillance-abn')
</div>
