<div wire:ignore.self id="editNewRecette" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="my-modal-title">Edition d'une nouvelle recette</h5>
            ...
            <div class="modal-footer">
                <button class="btn btn-primary" wire:click='update' type="button">Ajouter</button>
            </div>
        </div>
    </div>
</div>
