<!-- Modal -->
<div wire:ignore.self class="modal fade" id="showOrderFacturePharmaAbonneModal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                           ...
                           <table class="table table-sm">
                               ...
                               <tbody>
                                    <div>
                                        @if ($demande->products->isEmpty() and $demande->products->isEmpty())
                                        ...
                                        @else
                                            ...
                                            @foreach ($itemMedicationPv as $medication)
                                                <tr>
