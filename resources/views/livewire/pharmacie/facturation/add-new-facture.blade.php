<div wire:ignore.self id="newFactureModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title text-bold text-primary" id="my-modal-title">
                    <span style="font-size: 20px;">CREATION FACTURE AMBULANTS</span>
                </h3>
                <button
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label>Nom du patient ou designation</label>
