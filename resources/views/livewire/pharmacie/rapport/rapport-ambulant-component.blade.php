<div>
    <div class="card">
        <div class="card-header">
            RAPPORT DE LA PHARMACIE POUR LES AMBULANTS
        </div>
        ...
        @else
            <div class="card-body">
                ...
                <div>
                    <a target="_black" href="{{ route('sitution.ambulatnt.print',$currentDate) }}" class="btn btn-primary"><i class="fa fa-print" aria-hidden="true"></i></a>
