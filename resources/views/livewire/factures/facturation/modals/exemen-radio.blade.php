<div>
    <div wire:ignore.self class="modal fade" id="detailRadioModal">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="p-3">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="form-check">
                                        <input class="form-check-input" value="{{ $radio->id }}" wire:model.defer="itemRadio" type="checkbox" >
                    ...
                    <button class="btn btn-dark mt-2" type="button"  wire:click="addRadioDtail()">
