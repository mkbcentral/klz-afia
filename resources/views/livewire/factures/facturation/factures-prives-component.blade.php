<div>
    ...
    <div class="col-md-12">
        <div class="card card-secondary card-outline">
          <div class="card-header">
            <h3 class="modal-title text-bold text-primary" id="my-modal-title">
                <span style="font-size: 20px;">LISTE DES FACTURES PRIVES</span>
            </h3>
            <!-- /.card-tools -->
          </div>
          <!-- /.card-header -->
                                    ...
                                    @foreach ($factures as $facture)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <button wire:click='show({{$facture->id}})' data-toggle="modal" data-target="#showdDetailFacturerModal" class="btn btn-info btn-sm" type="button">
                                                ...
                                                <a href="{{ route('create.facture',$facture) }}" class="btn btn-danger btn-sm"><i class="fab fa-telegram"></i></a>
                                                <a target="_blank" href="" class="btn btn-secondary btn-sm"><i class="fas fa-print"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
      ...
      <!-- /.col -->
      @include('livewire.factures.facturation.show-detail-fact')
