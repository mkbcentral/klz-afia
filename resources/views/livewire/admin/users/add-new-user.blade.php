<div wire:ignore.self id="addNewUserModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary" type="button" wire:click='store'>Sauvegarder</button>
            </div>
        </div>
    </div>
</div>
