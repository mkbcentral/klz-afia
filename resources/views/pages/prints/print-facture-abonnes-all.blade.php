                ...
                <table>
                    ...
                    <tbody>
                            <tr>
                                ...
                                <td class="m-price2" style="">{{ ($demande->consultation->price_abonne*$rate)}} </td>
                            </tr>
                            <tr class="row">
                                <td ></td>
                                <td class="m-price" style=" ">Total: {{ number_format($demande->consultation->price_abonne*$rate, 0, ',', '') }}</td>
                                    {{ $total_cons+=$total_cons+$demande->consultation->price_abonne*$rate }}
                            </tr>
                    </tbody>
                </table>
            @endif
                        ...
                        <tbody>
                            ...
                            @foreach ($demande->examenLabos as $labo)
                                <tr>
                                    ...
                                    <td class="m-price2">
                                        {{ $labo->price_abonne*$rate }}
                                    </td>
                                    <td class="m-price2">
                                        {{ $labo->price_abonne*$rate*$labo->pivot->qty }}
                                    </td>
                                </tr>
                                Total: {{$total_labo+= $labo->price_abonne*$rate*$labo->pivot->qty }} CDF
                            @endforeach
                                <tr class="row">
                        ...
                        <tbody>
                            @foreach ($demande->examenRadios as $data_radio)
                                <tr>
                                    ...
                                    <td class="m-price">
                                        {{ $data_radio->price_abonne*$rate }}
                                    </td>
                                    <td class="m-price">
                                        {{ $data_radio->price_abonne*$rate*$data_radio->pivot->qty }}
                                    </td>
                                </tr>
                                {{$total_radio+= $data_radio->price_abonne*$rate*$data_radio->pivot->qty }} CDF
                            @endforeach
                                <tr class="row">
                        ...
                        <tbody>
                            @foreach ($demande->echographies as $echo)
                                <tr>
                                    ...
                                    <td class="des">1</td>
                                    <td class="m-price">
                                        {{ $echo->price_abonne*$rate }}
                                    </td>
                                    <td class="m-price">
                                        {{ $echo->price_abonne*$rate*1 }}
                                    </td>
                                </tr>
                                {{$total_echo+= $echo->price_abonne*$rate }} CDF
                            @endforeach
                                <tr class="row">
                                    <td class="des"  style="border-right: none;" ></td>
                                    <td></td>
                        ...
                        <tbody>
                            @foreach ($demande->autres as $data_autres)
                                <tr>
                                    ...
                                    <td class="m-price">
                                        {{ $data_autres->price_abonne*$rate }}
                                    </td>
                                    <td class="m-price">
                                        {{ $data_autres->price_abonne*$rate*$data_autres->pivot->qty }}
                                    </td>
                                </tr>
                                {{$total_autres+= $data_autres->price_abonne*$rate*$data_autres->pivot->qty }} CDF
                            @endforeach
                                <tr class="row">
                                    <td class="des"  style="border-right: none;" ></td>
                                    <td></td>
                        ...
                        <tbody>
                            @foreach ($demande->nursings as $nursings)
                                <tr>
                                    ...
                                    <td class="m-price">
                                    {{$nursings->price*$rate*$nursings->qty}}
                                    </td>
                                </tr>
                                @php
                                    $total_nursing+= $nursings->price*$rate*$nursings->qty
                                @endphp
                            @endforeach
                                <tr class="row">
                                    <td class="des"  style="border-right: none;" ></td>
                        ...
                        <tbody>
                            @foreach ($demande->sejours as $data_sejour)
                                <tr>
                                    ...
                                    <td class="m-price">
                                        @if ($demande->fiche->type=="Abonné")
                                            {{ $data_sejour->price_abonne*$rate*$data_sejour->pivot->qty }}
                                        @else
                                            {{ $data_sejour->price_abonne*$rate*$data_sejour->pivot->qty }}
                                        @endif
                                    </td>
                                ...
                                @if ($demande->fiche->type=="Abonné")
                                    {{$total_sejours += $data_sejour->price_abonne*$rate*$data_sejour->pivot->qty }}CDF
                                @else
                                    {{$total_sejours += $data_sejour->price_abonne*$rate*$data_sejour->pivot->qty }} CDF
                                @endif
                            @endforeach
